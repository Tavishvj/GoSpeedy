...
<div class="container-fluid bg-dark text-light p-3 d-flex align-items-center justify-content-between sticky-top">
    ...
    <a href="logout.php" class="btn btn-light btn-sm"><b>LOGOUT</b></a>
        ...
        <div class="container-fluid flex-lg-column align-items-stretch">
            ...
            <ul class="nav nav-pills flex-column">
               ...
               <li class="nav-item">
                 ...
                 <li class="nav-item">
                    <a class="nav-link text-white" href="product.php">Vehicle</a>
                 </li>  
               <li class="nav-item">
                   <button class="btn text-white px-3 w-100 shadow-none text-start d-flex align-items-center justify-content-between" type="button" data-bs-toggle="collapse" data-bs-target="#booking">
                    ...
                    <div class="collapse px-3 small mb-1 "  id="booking">
                        <ul class="nav nav-pills flex-column rounded border border-secondary">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white" href="bookings.php">Booking Records</a>
                ...
                <li class="nav-item">
                    <a class="nav-link text-white" href="user queries.php">User Queries</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link text-white" href="rating_review.php">Ratings & Review</a>
                </li>
                <li class="nav-item">
